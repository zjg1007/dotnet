                ...
                default:
                    {
                        ...
                        sbPage.AppendFormat("       <li><a href=\"{0}/?id={1}\" aria-label=\"Previous\"><span aria-hidden=\"true\">&laquo;</span></a></li>",
                        ...
                        for (int i = 1; i <= totalPage; i++)
                        {
                            ...
                            sbPage.AppendFormat("       <li {1}><a href=\"{2}/?id={0}\">{0}</a></li>",
                                i,
                        ...
                        sbPage.Append("       <li>");
                        sbPage.AppendFormat("         <a href=\"{0}/?id={1}\" aria-label=\"Next\">",
                                            PagerOption.RouteUrl,
